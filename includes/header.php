			...
			<div id='help_info'>
				...
				<div id='help_contents'>
					<dl>
						...
						<dd>The Freedom Archives search site also understands Boolean search logic, specifcally AND/+, NOT/-, and OR operators. Click on <a target='_new' href='http://libguides.mit.edu/c.php?g=175963&p=1158594'>this link</a> for a brief tutorial on how to use Boolean search logic. Our search function also understands “fuzzy searches.” Fuzzy searches utilize the (*) and will find matches even when users misspell words or enter in only partial words for the search. For example, searching for liber* will produce results for liberation/liberate/liberates/etc.</dd>
